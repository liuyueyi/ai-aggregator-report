...
- **Epic: Shard all 20 god files — repo-wide god-file decomposition**  (51 评论)  [Hermes Agent (Issue)](https://github.com/NousResearch/hermes-agent/issues/78647)
...
## OpenClaw
- PRs: 5 · Issues: 0 · Releases: 3
- **perf: avoid event-loop stall during embedded_run bootstrap-context**  (365 评论)  [OpenClaw (PR)](https://github.com/openclaw/openclaw/pull/89040)
...
- **fix(context-engine): keep background maintenance from blocking new messages**  (165 评论)  [OpenClaw (PR)](https://github.com/openclaw/openclaw/pull/97175)
- **feat(queue): persist followup queues across gateway restarts**  (135 评论)  [OpenClaw (PR)](https://github.com/openclaw/openclaw/pull/82572)
...
- **feat(channels/telegram): add multi_message streaming mode**  (23 评论)  [ZeroClaw (PR)](https://github.com/zeroclaw-labs/zeroclaw/pull/8561)
